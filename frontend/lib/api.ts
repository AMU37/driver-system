...
export type PlannedTrip = { id: number; external_id?: string | null; trip_number: string; driver_id: string; company_code: string; trip_date: string; trip_type?: string | null; release_at?: string | null; scheduled_start_at: string; status: string; bus_number?: string | null; route_name?: string | null; origin?: string | null; destination?: string | null };
